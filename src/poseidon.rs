...
use ark_crypto_primitives::{
    ...
    //crh::constraints::FixedLengthCRHGadget,
};
...
//use crate::test_poss::poseidon_parameters_for_test;
...
pub const POSEIDON_PARTIAL_ROUNDS: usize = 37;
pub const POSEIDON_SBOX: PoseidonSbox=PoseidonSbox::Exponentiation(5);

#[derive(Default,Clone, Debug)]
pub struct Typ1;
impl poseidon::PoseidonRoundParams<Fq> for Typ1 {
...
//pub type tmptype= poseidon::PoseidonRoundParams<Fq>;
pub type PoseidonParam =Poseidon<Fq, Typ1>;
pub type CRHFunction =PoseidonCRH<Fq, Typ1>;
...
impl ConstraintSynthesizer<Fq> for CRHCircuit{
	...
	fn generate_constraints(self, cs: ConstraintSystemRef<Fq>) -> Result<(), SynthesisError>{
        ...
        .unwrap();      
        //		crh_circuit_helper(&self.param, &self.input, &self.output, cs,pos_param_var)?; 
...
#[allow(dead_code)]
pub fn groth_param_gen1(param11: PoseidonParam) -> <Groth16<Bls12_381> as SNARK<Fq>>::ProvingKey {
   /* let seed =  &[32u8; 32];
...
pub(crate) fn crh_circuit_helper(
	...
	// step 4. Actual output
	 let actual_out_var = <PoseidonCRHGadget<Fq,Typ1> as FixedLengthCRHGadget<_,Fq >>::OutputVar::new_input(
    ...
    //println!("actual_output_var = {:?}",actual_out_var);
	Ok(())
}
use ark_std::vec;
//use ark_test_curves::bls12_381::Fr;
//use ark_ff::{One, PrimeField,UniformRand,bytes::ToBytes};
use ark_ff::PrimeField;


pub fn poseidon_parameters_for_test1<F: PrimeField>(mut pos: Poseidon<F, Typ1>) -> Poseidon<F, Typ1> {
    //let alpha = 5;
    let mds = vec![
        vec![
            F::from_str(
...
// pub static mdsmatrix: Vec<Vec<Fq>> = vec![
//     vec![
//         Fr::from_str(
//             "43228725308391137369947362226390319299014033584574058394339561338097152657858",
//         )
